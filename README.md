# Garoon Schedule Notifier

サイボウズ株式会社のグループウェア Garoon の予定通知を強化する Chrome 拡張機能（Manifest V3）です。デスクトップ通知と通知音で予定を見逃さず、ツールバーのポップアップから今日の予定を確認でき、ツールバーアイコンには次の予定の開始時刻が表示されます。
